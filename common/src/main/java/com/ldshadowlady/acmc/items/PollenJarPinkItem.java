	...
	public InteractionResult useOn(UseOnContext context) {
        ...
        if (blockstate.getBlock().equals(ROSE_BUSH) ||
            ...
            if (!world.isClientSide) {
                ...
                if (blockstate.getBlock().equals(ROSE_BUSH)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_ROSE.get());
				} else if (blockstate.getBlock().equals(DANDELION)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_DANDELION.get());
				} else if (blockstate.getBlock().equals(POPPY)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_POPPY.get());
				} else if (blockstate.getBlock().equals(BLUE_ORCHID)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_ORCHID.get());
				} else if (blockstate.getBlock().equals(ALLIUM)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_ALLIUM.get());
				} else if (blockstate.getBlock().equals(AZURE_BLUET)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_AZURE_BLUET.get());
				} else if (blockstate.getBlock().equals(RED_TULIP)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_TULIP.get());
					...
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_DAISY.get());
				} else if (blockstate.getBlock().equals(CORNFLOWER)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_CORNFLOWER.get());
				} else if (blockstate.getBlock().equals(LILY_OF_THE_VALLEY)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_LILY.get());
				} else if (blockstate.getBlock().equals(WITHER_ROSE)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_WITHER_ROSE.get());
				} else if (blockstate.getBlock().equals(SUNFLOWER)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_SUNFLOWER.get());
				} else if (blockstate.getBlock().equals(LILAC)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_LILAC.get());
				} else if (blockstate.getBlock().equals(PEONY)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_PEONY.get());
				} else if (blockstate.getBlock().equals(ALLIUM)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_PINK_ALLIUM.get());
				}
