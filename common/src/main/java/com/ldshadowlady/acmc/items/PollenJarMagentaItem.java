	...
	public InteractionResult useOn(UseOnContext context) {
        ...
        if (blockstate.getBlock().equals(ROSE_BUSH) ||
            ...
            if (!world.isClientSide) {
                ...
                if (blockstate.getBlock().equals(ROSE_BUSH)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_ROSE.get());
				} else if (blockstate.getBlock().equals(DANDELION)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_DANDELION.get());
				} else if (blockstate.getBlock().equals(POPPY)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_POPPY.get());
				} else if (blockstate.getBlock().equals(BLUE_ORCHID)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_ORCHID.get());
				} else if (blockstate.getBlock().equals(ALLIUM)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_ALLIUM.get());
				} else if (blockstate.getBlock().equals(AZURE_BLUET)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_AZURE_BLUET.get());
				} else if (blockstate.getBlock().equals(RED_TULIP)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_TULIP.get());
					...
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_DAISY.get());
				} else if (blockstate.getBlock().equals(CORNFLOWER)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_CORNFLOWER.get());
				} else if (blockstate.getBlock().equals(LILY_OF_THE_VALLEY)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_LILY.get());
				} else if (blockstate.getBlock().equals(WITHER_ROSE)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_WITHER_ROSE.get());
				} else if (blockstate.getBlock().equals(SUNFLOWER)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_SUNFLOWER.get());
				} else if (blockstate.getBlock().equals(LILAC)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_LILAC.get());
				} else if (blockstate.getBlock().equals(PEONY)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_PEONY.get());
				} else if (blockstate.getBlock().equals(ALLIUM)) {
					ItemEntity ent = player.spawnAtLocation(ACMCBlocks.CROP_MAGENTA_ALLIUM.get());
				}
