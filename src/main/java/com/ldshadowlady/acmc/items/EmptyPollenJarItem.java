...
public class EmptyPollenJarItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		if (blockstate.getBlock().equals(ROSE_BUSH) ||
			...
			if (!world.isClientSide) {
				...
				if (blockstate.getBlock().equals(ROSE_BUSH)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_ROSE.get());
				} else if (blockstate.getBlock().equals(WITHER_ROSE)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_WITHER_ROSE.get());
				} else if (blockstate.getBlock().equals(POPPY)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_ROSE.get());
				} else if (blockstate.getBlock().equals(BLUE_ORCHID)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_ORCHID.get());
				} else if (blockstate.getBlock().equals(ALLIUM)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_ALLIUM.get());
				} else if (blockstate.getBlock().equals(DANDELION)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_DANDELION.get());
				} else if (blockstate.getBlock().equals(POPPY)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_POPPY.get());
				} else if (blockstate.getBlock().equals(AZURE_BLUET)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_AZURE_BLUET.get());
				} else if (blockstate.getBlock().equals(RED_TULIP)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_RED_TULIP.get());
				} else if (blockstate.getBlock().equals(ORANGE_TULIP)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_ORANGE_TULIP.get());
				} else if (blockstate.getBlock().equals(WHITE_TULIP)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_WHITE_TULIP.get());
				} else if (blockstate.getBlock().equals(PINK_TULIP)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_PINK_TULIP.get());
				} else if (blockstate.getBlock().equals(OXEYE_DAISY)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_DAISY.get());
				} else if (blockstate.getBlock().equals(CORNFLOWER)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_CORNFLOWER.get());
				} else if (blockstate.getBlock().equals(LILY_OF_THE_VALLEY)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_LILY_OF_THE_VALLEY.get());
				} else if (blockstate.getBlock().equals(WITHER_ROSE)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_WITHER_ROSE.get());
				} else if (blockstate.getBlock().equals(SUNFLOWER)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_SUNFLOWER.get());
				} else if (blockstate.getBlock().equals(LILAC)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_LILAC.get());
				} else if (blockstate.getBlock().equals(PEONY)) {
					ItemEntity ent = player.spawnAtLocation(ACMCItems.POLLEN_JAR_PEONY.get());
				}
	...
	public void appendHoverText(ItemStack itemStack, @Nullable Level world, List<Component> list, TooltipFlag flag) {
		list.add(new TranslatableComponent("item.empty_pollen_jar.desc"));
	}
